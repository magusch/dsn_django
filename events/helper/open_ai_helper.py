        ...
        completion = self.client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user",
                 ...
                 Выделить категорию мероприятия. Выделить несколько важных тегов мероприятия. Результат выдать в виде названия информации (заголовк, текст) затем элемент в виде '=>', результат и в конце поставить точку с запятой (;).
                 МЕРОПРИЯТИЕ:
